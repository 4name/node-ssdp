...
describe('SSDP Header class', function () {
  context('constructor', function () {
    ...
    it('generates random ID', function () {
      const h1 = new Header('method');
      const h2 = new Header('method');
  ...
  context('#toString', function () {
    it('returns a string', function () {
      const hRequest = new Header('method', { foo: 1, BAR: 'two' });

      const expectedRequestString = 'METHOD * HTTP/1.1\r\nfoo: 1\r\nBAR: two\r\n\r\n';
      expect(hRequest.toString()).to.equal(expectedRequestString);

      const hResponse = new Header('method', { foo: 1, BAR: 'two' }, true);

      const expectedResponseString = 'HTTP/1.1 METHOD\r\nfoo: 1\r\nBAR: two\r\n\r\n';
  ...
  context('#toBuffer', function () {
    it('returns a buffer', function () {
      ...
      const expectedRequestBuffer = Buffer.from('METHOD * HTTP/1.1\r\nfoo: 1\r\nBAR: two\r\n\r\n');
